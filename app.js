...
const lclearLastE1 = document.querySelector('.last-entity-clear');
...
lclearLastE1.addEventListener('click', (e) =>{
    display2E1.innerText = '';
    // var str = display2E1.innerText.value;
    // new1 = str.substring(0,(str.length-1));
    // display2E1.innerText.value = new1;
    dis2Num = '';
});
